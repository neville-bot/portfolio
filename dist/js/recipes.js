...
function wireStickyIngredients({ bar, panel, threshold }) {
  const btn = bar.querySelector('button') || bar;
...
if (typeof module !== 'undefined') {
  module.exports = { escHtml, parseQuantity, renderRecipe, wireStickyIngredients, init };
}
